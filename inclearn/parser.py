...
def get_parser():
    ...
    parser.add_argument("--mode", type=str, default="train",
                        help="Experiment mode, train or eval")
    ...
    parser.add_argument("-save", "--save-model", choices=["never", "last", "task", "first"],
                        ...
                        help="Save the network, either the `last` one or"
                             " each `task`'s ones.")
    parser.add_argument("-savel", "--save-latest", action="store_true")
    ...
    parser.add_argument("--logits-save-dir", default=None,
                        help="Directory to save the logits")
