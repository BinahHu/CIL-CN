...
def parse_args():
    ...
    parser.add_argument("-cmd", "--cmd", default="/home/zhiyuan/CIL-CN/hyperexps/cmd.yaml")
...
def get_tune_config(tune_options, options_files, cmd_file):
    with open(tune_options) as f:
        options = yaml.load(f, Loader=yaml.FullLoader)

    with open(cmd_file) as f:
        cmd_options = yaml.load(f, Loader=yaml.FullLoader)
...
def main():
    ...
    if args.tune is not None:
        config = get_tune_config(args.tune, args.options, args.cmd)
